  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <motion.div 
          className="mx-auto w-20 h-20 bg-gradient-to-br from-teal-500 to-purple-600 rounded-2xl flex items-center justify-center"
          animate={{ rotate: 360 }}
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActive && "bg-primary/10 dark:bg-primary/5 shadow-sm",
            ...
            >
              ...
              <div className={cn(
                ...
                isActive && "bg-gradient-to-br from-teal-500 to-purple-600",
                isUpcoming && "bg-muted"
              )}>
                {isCompleted ? (
