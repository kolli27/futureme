...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['var(--font-inter)', '-apple-system', 'BlinkMacSystemFont', 'SF Pro Display', 'Segoe UI', 'system-ui', 'sans-serif'],
        display: ['-apple-system', 'BlinkMacSystemFont', 'SF Pro Display', 'var(--font-inter)', 'system-ui', 'sans-serif'],
        mono: ['var(--font-geist-mono)', 'ui-monospace', 'SF Mono', 'Monaco', 'Cascadia Code', 'Roboto Mono', 'Consolas', 'monospace'],
      },
      backgroundImage: {
        ...
        'gradient-neon': 'linear-gradient(45deg, #00f5ff, #ff00f5, #f5ff00, #00ff5f)',
      },
      animation: {
